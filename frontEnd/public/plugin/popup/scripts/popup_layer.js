...
var PopupLayer1 = PopupLayer2 = PopupLayer3 = PopupLayers1 = PopupLayers2 = PopupLayers3 = new Class({
	options:{
	...
	_init:function(options){
        ...
        if(winWide<768)
        {
          this.setPosition(0, this.trigger.offset().top + this.trigger.get(0).offsetHeight + this.options.offsets.y);
        }
				else
        {
...
$(document).ready(function(){
  ...
  if(winWide<768)
  {
    $("#blk1 li").click(function(){
      var someValue=$(this).text();
       $("#inputs1").val(someValue);
       if(someValue==02)
       {
         document.getElementById("inputs2").value='00';
         document.getElementById("inputs2").readOnly=true;
         document.getElementById("inputs3").value='00';
         document.getElementById("inputs3").readOnly=true;
         document.getElementById("notices").style.display="block";
       }
       else
       {
         document.getElementById("notices").style.display="none";
         document.getElementById("inputs2").readOnly=false;
         document.getElementById("inputs3").readOnly=false;
       }
    });
    $("#blk2 li").click(function(){
      var someValue=$(this).text();
      var flag=document.getElementById("inputs2").readOnly;
      if(flag!=true)
      {
        $("#inputs2").val(someValue);
      }
    });
    $("#blk3 li").click(function(){
      var someValue=$(this).text();
      var flag=document.getElementById("inputs3").readOnly;
      if(flag!=true)
      {
        $("#inputs3").val(someValue);
      }
    });
  }
  else
  {
    $("#blk1 li").click(function(){
       var someValue=$(this).text();
       $("#input1").val(someValue);
       if(someValue==02)
       {
         document.getElementById("input2").value='00';
         document.getElementById("input2").readOnly=true;
         document.getElementById("input3").value='00';
   ...
   $("#blk2 li").click(function(){
      var someValue=$(this).text();
      var flag=document.getElementById("input2").readOnly;
      if(flag!=true)
      {
        $("#input2").val(someValue);
      }
    });
    $("#blk3 li").click(function(){
       var someValue=$(this).text();
       var flag=document.getElementById("input3").readOnly;
       if(flag!=true)
       {
...
$("button").click(function(){
  ...
  var inputValueS1=document.getElementById("inputs1").value();
  if(input1Value!=00&&inputValue1!=01&&inputValue1!=02)
  {
    document.getElementById("input1").value()='02';
  }
});
